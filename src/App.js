...
const features = [
  {
    ...
    desc: "Production-grade deployment on AWS EC2 with auto-scaling, load balancing, and high availability configurations.",
    tag: "Infrastructure",
  },
  {
    icon: icons.gear,
    title: "Jenkins CI/CD Pipelines",
    desc: "Fully automated build, test, and deploy workflows integrated directly with GitHub repositories and webhooks.",
    tag: "Automation",
  },
  {
    icon: icons.cube,
    title: "Docker Containerization",
    desc: "Containerized microservices architecture ensuring consistent environments from development to production.",
    tag: "Containers",
  },
  {
    icon: icons.shield,
    title: "Security & Compliance",
    desc: "Built-in security scanning, secrets management, and compliance monitoring across your entire infrastructure.",
    tag: "Security",
  },
  {
    icon: icons.chart,
    title: "Real-time Monitoring",
    desc: "Comprehensive observability with metrics, logs, and traces for every service in your deployment pipeline.",
    tag: "Observability",
  },
  {
    icon: icons.bolt,
    title: "Instant Rollbacks",
    desc: "Zero-downtime deployments with automatic health checks and instant rollback capabilities on failure.",
    tag: "Reliability",
  },
];
...
function Navbar() {
  return (
    <nav
      id="navbar"
      className="fixed top-0 left-0 right-0 z-50 bg-slate-950/70 backdrop-blur-xl border-b border-white/[0.06]"
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 lg:px-10 py-4">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="#deploy" className="nav-link">
            Deploy
          </a>
        </div>
        ...
        <div className="flex items-center gap-3">
          <a
            href="#deploy"
            className="hidden sm:inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500 text-sm font-semibold hover:from-cyan-400 hover:to-blue-400 transition-all duration-300 shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 hover:-translate-y-0.5"
          >
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center section-padding animate-fade-in">
        ...
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold tracking-tight leading-[1.05] text-balance animate-fade-in-up">
          Production-Grade <span className="gradient-text">DevOps</span>
        ...
        <p className="mt-8 text-lg sm:text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed animate-fade-in-up animation-delay-200">
          Ship faster with enterprise CI/CD pipelines powered by AWS, Docker,
          Jenkins, and GitHub — all orchestrated from a single platform.
        </p>
        ...
        <div className="mt-12 flex flex-wrap items-center justify-center gap-4 animate-fade-in-up animation-delay-400">
          <button
            id="hero-cta-primary"
            className="group inline-flex items-center gap-2.5 px-8 py-4 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-500 text-base font-semibold hover:from-cyan-400 hover:to-blue-400 transition-all duration-300 shadow-xl shadow-cyan-500/25 hover:shadow-cyan-500/40 hover:-translate-y-1"
          >
            Start Deploying
          ...
          <button
            ...
            className="inline-flex items-center gap-2.5 px-8 py-4 rounded-2xl glass-card text-base font-semibold hover:bg-white/[0.08] transition-all duration-300 hover:-translate-y-1"
          >
        ...
        <div className="mt-16 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-sm text-slate-500 animate-fade-in-up animation-delay-600">
          <span className="flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" /> 99.9%
            Uptime
          </span>
          <span className="flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-cyan-500" /> SOC 2
            Compliant
          </span>
          <span className="flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-blue-500" /> Enterprise
            Ready
          </span>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className="mt-6 text-lg text-slate-400 max-w-2xl mx-auto">
            A complete DevOps toolkit designed for teams who demand reliability,
            speed, and full observability across their infrastructure.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((f, i) => (
            <div key={i} className="glass-card-hover p-8 group">
              ...
              <span className="text-[11px] font-semibold tracking-widest uppercase text-cyan-400/70 mb-3 block">
                {f.tag}
              </span>
    ...
    <section id="pipeline" className="relative py-32 section-padding">
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl sm:text-5xl font-extrabold tracking-tight mt-4">
            From <span className="gradient-text">commit to production</span> in
            minutes
          </h2>
          <p className="mt-6 text-lg text-slate-400 max-w-2xl mx-auto">
            Every code push triggers a fully automated pipeline — build, test,
            containerize, and deploy with zero manual intervention.
          </p>
        </div>
          ...
          {pipelineSteps.map((step, i) => (
            <div key={i} className="relative group">
              <div className="glass-card-hover p-6 text-center h-full">
                <span className="text-3xl font-extrabold gradient-text font-mono block mb-3">
                  {step.num}
                </span>
        ...
        <div className="mt-16 glass-card overflow-hidden max-w-3xl mx-auto">
          <div className="flex items-center gap-2 px-5 py-3.5 border-b border-white/[0.06]">
            ...
            <span className="ml-4 text-xs text-slate-500 font-mono">
              cloudops-nexus — pipeline.log
            </span>
          </div>
          <div className="p-6 font-mono text-sm leading-7 text-slate-300 space-y-1">
            <p>
              <span className="text-cyan-400">$</span> git push origin main
            </p>
            <p className="text-slate-500">
              [webhook] Trigger received from GitHub...
            </p>
            <p>
              <span className="text-emerald-400">✓</span> Build completed{" "}
              <span className="text-slate-500">— 18.3s</span>
            </p>
            <p>
              <span className="text-emerald-400">✓</span> Tests passed{" "}
              <span className="text-slate-500">— 142/142</span>
            </p>
            <p>
              <span className="text-emerald-400">✓</span> Docker image built{" "}
              <span className="text-slate-500">— cloudops/app:v2.0.4</span>
            </p>
            <p>
              <span className="text-emerald-400">✓</span> Deployed to EC2{" "}
              <span className="text-slate-500">— us-east-1</span>
            </p>
            <p className="text-cyan-400 pt-2">
              → Live at https://app.cloudops-nexus.io
            </p>
          </div>
        </div>
      </div>
...
function DeployCTA() {
  return (
    <section
      id="deploy"
      className="relative py-32 section-padding overflow-hidden"
    >
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        ...
        <p className="mt-6 text-lg text-slate-400 max-w-xl mx-auto leading-relaxed">
          Connect your repository, configure your pipeline, and let CloudOps
          Nexus handle the rest. No infrastructure expertise required.
        </p>
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          <button
            id="cta-start"
            className="group inline-flex items-center gap-2.5 px-10 py-4 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-500 text-base font-semibold hover:from-cyan-400 hover:to-blue-400 transition-all duration-300 shadow-xl shadow-cyan-500/25 hover:shadow-cyan-500/40 hover:-translate-y-1"
          >
            Start Free Trial
          ...
          <button
            id="cta-docs"
            className="inline-flex items-center gap-2.5 px-10 py-4 rounded-2xl glass-card text-base font-semibold hover:bg-white/[0.08] transition-all duration-300 hover:-translate-y-1"
          >
            Read the Docs
          </button>
        </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-16">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-slate-500 leading-relaxed">
              Production-grade DevOps automation for modern engineering teams.
            </p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between pt-8 border-t border-white/[0.06] gap-4">
          <p className="text-xs text-slate-600">
            © 2026 CloudOps Nexus. All rights reserved.
          </p>
          <div className="flex items-center gap-6 text-xs text-slate-500">
            <span>
              Built with AWS • Jenkins • Docker • GitHub • React • By
              Vaibhav{" "}
            </span>
          </div>
        </div>
